...
defaultproperties
{
    ...
    DisplayInfo(1)=(Section="Enhanced Netcode",Caption="Ping frequency",Hint="Frequency to send pings (pings/second).",Step="0.25",bAdvanced=true)
    DisplayInfo(2)=(Section="Enhanced Netcode",Caption="Ping smoothing factor",Hint="Factor to smooth out ping spikes from the average. Use low values for high smoothing (1.0 disables averaging completely).",Step="0.05",bAdvanced=true)
